    ...
    drawText: function(featureId, style, location) {
        ...
        if (style.labelBackgroundColor || style.labelBorderColor || style.labelBorderSize) {
            ...
            if (style.labelBorderColor || style.labelBorderSize) {
                bg.setAttributeNS(null, "stroke", (style.labelBorderColor || "#"));
                bg.setAttributeNS(null, "stroke-width", (style.labelBorderSize || "0.5"));
            }
            ...
            if (style.labelPadding) {
                ...
                if (pos === -1) {
                    ...
                    padding = parseInt(style.labelPadding.substr(0, pos), 10);
                }
            }
